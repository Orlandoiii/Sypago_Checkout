    ...
    return (
        ...
        <div className="flex flex-col [&>*]:mb-2 py-8 px-4">
            ...
            <button type="button" id=""
              ...
              ${isValidOtp() ? "bg-primary" : "bg-gray-500"}`} disabled={!isValidOtp()}
                onClick={(e) => {
                    if (onSubmitOtpEvent)
